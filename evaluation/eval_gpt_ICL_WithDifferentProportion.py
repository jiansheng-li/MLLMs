...
def gen_prompt(ice_num, qs, args, query_img_base64, ice_data_path):
...
def main(args, dataset):
    for idx, each_dataset in enumerate(args.dataset):
        ...
        for line in tqdm(questions):
            ...
            prompt_messages = gen_prompt(ice_num=args.ice_num, qs=qs, args=args, query_img_base64=base64_img,
