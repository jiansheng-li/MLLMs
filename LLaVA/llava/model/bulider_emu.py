...
def load_pretrained_intern_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False,
...
def load_pretrained_emu_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto",
                              device="cpu", **kwargs):
